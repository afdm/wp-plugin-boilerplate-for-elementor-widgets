...
class Plugin_Name {
	...
	private function load_dependencies() {
		 ...
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'elementor-widgets/class-plugin-name-elementor-widgets.php';
    ...
    private function define_elementor_widgets_hooks() {
        ...
        $plugin_elementor_widgets = new Plugin_Name_Elementor_Widgets( $this->get_plugin_name(), $this->get_version() );
